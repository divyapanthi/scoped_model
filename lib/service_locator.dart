...
void setUpLocator(){
  //Register services
  // lazysingleton means there will only be one instance of storage services
  // but it will only be created once the storage service for the first time
  locator.registerLazySingleton<StorageService>(() => StorageService());
  //Register models

  //registering as a factory so that every time we make request a
  //type model we get a new instance back.
